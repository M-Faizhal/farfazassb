    ...
    <div className="flex min-h-screen bg-[#f7f7f7]">
      ...
      <main className="flex-1 p-6">
        ...
        <form
          ...
          className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 max-w-6xl bg-white p-6 rounded-md shadow"
        >
          ...
          <div className="fixed inset-0 bg-black/20 backdrop-blur-none flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 shadow-lg max-w-md w-full">
              ...
              <div className="text-sm text-gray-800 space-y-1 mb-4">
                ...
                {preview && (
                  <img src={preview} alt="Preview" className="mt-2 w-full max-h-48 object-contain rounded-md border" />
                )}
              </div>
...
const PasswordField = ({ label, id, value, onChange, required, show, toggleShow }) => (
  <div className="flex flex-col relative">
    ...
    <input
      ...
      onChange={onChange}
      required={required}
      className="rounded-md bg-[#E6EEFF] border border-gray-300 h-10 px-3 pr-10 text-black focus:outline-primary"
    />
    <div
  ...
  <div className="flex flex-col">
    ...
    {!preview ? (
      ...
      <div className="mt-3 border rounded overflow-hidden">
        <img src={preview} alt={`Preview ${id}`} className="w-full max-h-64 object-contain" />
      </div>
    )}
  </div>
);
