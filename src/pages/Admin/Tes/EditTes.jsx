...
const EditTes = () => {
  ...
  const editTest = async () => {
    ...
    await Api.patch(
      ...
      toast.error("Gagal mengubah tes")
    })
    .finally(()=>{
      loadingSimpan(false)
    })
            ...
            <div className="fixed inset-0 bg-black/20 backdrop-blur-none flex items-center justify-center z-50 px-4">
              <div className="bg-white rounded-lg p-6 shadow-lg max-w-md w-full">
                ...
                <div className="text-sm text-gray-800 space-y-1 mb-4">
                  <p>
                    <strong>Nama Tes:</strong> {formData.name}
                  </p>
                  <p>
                ...
                <div className="flex flex-col sm:flex-row justify-end gap-3">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-primary disabled:bg-primary/50 text-white rounded-md w-full sm:w-auto"
                  >
                    {loadingSimpan? "Menyimpan" : "Ya, Simpan"}
                  </button>
                </div>
              </div>
            </div>
