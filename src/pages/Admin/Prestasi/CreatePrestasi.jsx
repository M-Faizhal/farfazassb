...
const CreatePrestasi = () => {
  ...
  const createPrestasi = async()=>{
    await Api.post("/admin/achievements",formData,{
      headers : {
        Authorization : "Bearer " + getToken()
      }
    }).then(()=>{
      toast.success("Sukses Membuat Prestasi")
      navigate(-1)
    })
  }
          ...
          >
            ...
            {kategori === "Individu" && (
              <div className="flex flex-col">
                <label
                  className="text-sm text-black mb-1 flex items-center gap-2"
                >
                  Nama Siswa
                </label>
                <select
              ...
              <div className="bg-white rounded-lg p-6 shadow-lg max-w-md w-full">
                ...
                <div className="mb-4 space-y-2 text-sm">
                  ...
                  <p>
                    ...
                    {formData.studentId === null? "Tim" : "Individu" }
                  </p>
                  <p>
                    <span className="font-medium">Peringkat:</span> Juara{" "}
                    {formData.place}
                  </p>
                  <p>
