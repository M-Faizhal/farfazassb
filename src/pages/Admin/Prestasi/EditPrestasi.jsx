...
const EditPrestasi = () => {
  ...
  useEffect(() => {
    if (id) {
      setFormData({
        judul: prestasiDummy.judul,
        kategori: prestasiDummy.kategori,
        tanggal: prestasiDummy.tanggal,
        tingkat: prestasiDummy.tingkat,
        peringkat: prestasiDummy.peringkat,
        deskripsi: prestasiDummy.deskripsi,
        namaSiswa: prestasiDummy.namaSiswa || '',
        namaEvent: prestasiDummy.namaEvent,
      });
    }
  }, [id]);
  ...
  const handleChange = (e) => {
    ...
    setFormData((prev) => ({ 
      ...prev, 
      [id]: value,
      ...(id === 'kategori' && value === 'Tim' && { namaSiswa: '' })
    }));
  };
  ...
  const handleSave = (e) => {
    ...
    const prestasiData = {
      id: id,
      ...formData,
      namaSiswa: formData.kategori === 'Tim' ? null : formData.namaSiswa,
    };

    console.log('Data prestasi diperbarui:', prestasiData);
    setShowSaveModal(false);
    setSuccessMessage('Data prestasi berhasil diperbarui!');
    setTimeout(() => {
  ...
  const daftarSiswa = [
    'Afif Bima Said',
    'Al Safaraz Akma Fadhil Prasetyo',
    'Muhammad Farhan',
    'Ahmad Rizky',
    'Bayu Pratama'
  ];
      ...
      <div className="flex flex-col md:flex-row mx-auto min-h-screen">
        ...
        <main className="flex-1 px-6 py-8 pt-20 md:pt-0 md:ml-64">
          ...
          <div className="flex items-center gap-3 mb-6 mt-6">
            ...
            <h2 className="text-black text-xl font-bold">Edit Data Prestasi</h2>
          </div>
            ...
            <div className="fixed inset-0 bg-black/20 backdrop-blur-none flex items-center justify-center z-50 px-4">
              <div className="bg-white rounded-lg p-6 shadow-lg max-w-md w-full">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h2 className="text-lg font-semibold">Konfirmasi Simpan Perubahan</h2>
                </div>
                <div className="mb-4 space-y-2 text-sm">
                  ...
                  {formData.kategori === 'Individu' && formData.namaSiswa && (
                    <p><span className="font-medium">Siswa:</span> {formData.namaSiswa}</p>
                  )}
                </div>
