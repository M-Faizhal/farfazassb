      ...
      <div className="flex flex-col md:flex-row  mx-auto min-h-screen">
        ...
        <main className="flex-1 px-6 py-8">
          ...
          <div className="flex justify-between items-center mb-6 mt-6">
            ...
            <button className="border border-gray-300 px-4 py-1 rounded-md font-semibold text-black bg-white hover:bg-gray-100">
              New
            </button>
          </div>
          ...
          <section className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
            {['Siswa', 'Pelatih', 'Orang Tua', 'Prestasi'].map((item, i) => (
              <div key={i} className="bg-blue-200 rounded-lg p-4 shadow-sm">
                <p className="text-sm font-medium text-gray-700 mb-1">Total {item}</p>
                <p className="text-2xl font-bold text-black">{i === 0 ? 200 : '—'}</p>
              </div>
            ))}
          </section>
          ...
          <section>
            ...
            <div className="overflow-x-auto bg-white rounded-md border border-gray-200 shadow-sm">
              <table className="w-full text-left table-auto">
                <thead className="bg-blue-50">
                  <tr>
                    <th className="px-4 py-2 font-semibold text-gray-700">Nama Siswa</th>
                    <th className="px-4 py-2 font-semibold text-gray-700">Tanggal</th>
                    <th className="px-4 py-2 font-semibold text-gray-700">Kelas</th>
                    <th className="px-4 py-2 font-semibold text-gray-700">Nilai</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-t">
