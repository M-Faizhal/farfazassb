...
const UserSidebar = () => {
  ...
  const menuItems = [
    { name: 'Data Orang Tua', path: '/user/dashboard' },
    { name: 'Data Siswa', path: '/user/siswa' },
    { name: 'Data Penilaian', path: '/user/penilaian' },
  ];
          ...
          return (
            <NavLink
              ...
              className={`px-3 py-2 rounded-md text-left font-medium transition-colors ${
                isActive
                ? 'bg-amber-100 text-amber-800 font-semibold border-r-4 border-amber-700'
      ...
      {showLogoutModal && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black/40">
          <div className="bg-white p-6 rounded-lg shadow-md w-[90%] max-w-md">
            ...
            <p className="text-sm text-gray-600 mb-6">Apakah Anda yakin ingin logout dari akun?</p>
